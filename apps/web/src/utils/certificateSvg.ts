...
export function generateCertificateSvg(opts: CertificateOptions): string {
  ...
  const competencyItems = opts.competencies
    ...
    .map(
      (comp, i) => `
      <g transform="translate(180, ${470 + i * 36})">
...
<svg width="1200" height="800" viewBox="0 0 1200 800" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <text x="600" y="425" text-anchor="middle" fill="${accent}" font-family="'JetBrains Mono', monospace" font-size="12" font-weight="600" letter-spacing="2">
